...
Files = ["LogisticRegression(C=3, class_weight=None, dual=False, fit_intercept=True,.csv", "LogisticRegressionCV(Cs=10, class_weight=None, cv=None, dual=False,.csv", "XGBoostClassifier(alpha=0, booster='gbtree', cache_opt=None, classes_=None,.csv"]
DataFrames = []
